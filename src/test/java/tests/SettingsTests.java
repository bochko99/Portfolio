...
public class SettingsTests extends MobileTest {
    ...
    public void testGetSettingsDeposits() {
        service().auth().get(EndPoints.settings_deposits);
    }
